...
class M2M_ConnectivityDirectoryClient extends M2M_M2mClient {
   ...
   */
 	public function __construct(M2M_ServiceConfigurator $oService) {
		parent::__construct($oService, $oService->get_sConnectivityDirectoryUrl(), dirname(__FILE__) . "/resources/ConnectivityDirectory_V1_13.wsdl" , $this->_aClassMap );
    }
  ...
  public function call_updateConnectivityDirectory($oInput) {
    ...
    /**
   * @param ServiceConfig $oInput
   * @return createCustomizedFieldsResponse  
   */
  public function call_createCustomizedFields($oInput) {
    
    try {
      // call the operation
      $oResponse = $this->_oSoapClient->createCustomizedFields ( $oInput );
    }
    catch ( Exception $e ) {
      parent::logRequest ( "A problem occured while calling " . __METHOD__);
      parent::logResponse (" Last Response (warning: may not be the response you expected if the request \"failed before reaching the endpoint\")." . __METHOD__ );      
    ...
    return $oResponse;
      ...
      /**
   * @param ServiceConfig $oInput
   * @return updateCustomizedFieldsResponse  
   */
  public function call_updateCustomizedFields($oInput) {
    
    try {
      // call the operation
      $oResponse = $this->_oSoapClient->updateCustomizedFields ( $oInput );
    }
    catch ( Exception $e ) {
      parent::logRequest ( "A problem occured while calling " . __METHOD__);
      parent::logResponse (" Last Response (warning: may not be the response you expected if the request \"failed before reaching the endpoint\")." . __METHOD__ );      
    ...
    return $oResponse;
        ...
        /**
   * @param ServiceConfig $oInput
   * @return getCustomizedFieldsResponse  
   */
  public function call_getCustomizedFields($oInput) {
    
    try {
      // call the operation
      $oResponse = $this->_oSoapClient->getCustomizedFields ( $oInput );
    }
    catch ( Exception $e ) {
      parent::logRequest ( "A problem occured while calling " . __METHOD__);
      parent::logResponse (" Last Response (warning: may not be the response you expected if the request \"failed before reaching the endpoint\")." . __METHOD__ );      
    ...
    return $oResponse;
        ...
        /**
   * @param ServiceConfig $oInput
   * @return deleteCustomizedFieldsResponse  
   */
  public function call_deleteCustomizedFields($oInput) {
    
    try {
      // call the operation
      $oResponse = $this->_oSoapClient->deleteCustomizedFields ( $oInput );
    }
    catch ( Exception $e ) {
      parent::logRequest ( "A problem occured while calling " . __METHOD__);
      parent::logResponse (" Last Response (warning: may not be the response you expected if the request \"failed before reaching the endpoint\")." . __METHOD__ );      
